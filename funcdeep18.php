...
<?php
	...
	/*1.Перебираем все ключи (числа базового массива).
	2.Ищем в массиве значение равное ключу и присваеваем его переменной $secnum.
	3.Получаем сумму делителей этого числа.
	4.Если сумма делителей найденного числа равна ключу-числу.
